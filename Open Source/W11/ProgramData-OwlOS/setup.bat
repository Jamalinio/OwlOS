...
echo	  - DirectX
C:\ProgramData\OwlOS\DirectX\DXSETUP.exe /silent >nul 2>&1
...
bcdedit /set {current} description "OwlOS 11 (22H2)" >nul 2>&1
...
echo Removing windows defender from startup
